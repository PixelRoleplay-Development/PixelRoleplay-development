...
local MugShotWebhook = 'https://discord.com/api/webhooks/1243646562429829170/rVEiXII27gPkKlb6JOCCrO-RAMpbtty8ovv70Xd8xt2Wa-_ixyH48I4QTxCi9DXGkcwV'

-- Clock-in notifications for duty. Add a Discord webhook.
-- Command /mdtleaderboard, will display top players per clock-in hours.
local ClockinWebhook = 'https://discord.com/api/webhooks/1243646314277900298/zwNRB9f_9ZXUGEFYPjf7wmIldOFn-zNU7yotjRH0lEUkjXTnVyYs7laRPo6CgOQSxAGv'

-- Incident and Incident editting. Add a Discord webhook.
-- Incident Author, Title, and Report will display in webhook post.
local IncidentWebhook = 'https://discord.com/api/webhooks/1243646494658134179/XdDnaEZyE89UBZ2QOEV2k0kfvclNtxZpca0VdpFcGAweQJCFZYtbjhUbPSMOld8iQsZF'
--------------------------------
...
RegisterNetEvent('mdt:server:removeMoney', function(citizenId, fine, incidentId)
	...
	if not antiSpam then
		if Player.Functions.RemoveMoney('bank', fine, 'Law Enforcement Fine') then
